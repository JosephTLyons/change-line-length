...
function dealWithSettingsPane()
{
    if (atom.config.get ('change-line-length.settingsWarningIsDisplayed'))
...
function displayWarning()
{
    ...
    notifications.addWarning ("There are visual bugs associated with using with the settings view\
    open.  Closing the settings view is recommended for a smoother experience.  This warning can be\
    toggled off in the package settings.");
